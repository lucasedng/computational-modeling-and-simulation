...
#define vo 15            //Vel. Inicial (m/s)
#define soy 250          //Alt. Inicial  (m)
#define g 9, 8           //Gravidade (m/s²)
#define m 1              //Massa do corpo (kg)
#define k 0.25           //Coef. de Atrito (-)
#define deltat 0.01      //Passo da integração (s)
#define pi 3.14159265359 //Valor de pi (-)
#define theta pi / 4     //Ângulo de lançamento (rad)

int main()
{
    //Criando um arquivo .txt para guardar os dados
    FILE *pont_arq;
    pont_arq = fopen("Simulação1.txt", "wt");
    if (pont_arq == NULL)
    {
